...
public class TerrainRenderer {
	...
	private void prepairTerrain(Terrain terrain) {
	...
	private void loadModelMatrix(Terrain terrain) {
		Matrix4f transMatrix = Maths.createTransMatrix(new Vector3f(terrain.getX(), 0, terrain.getZ()), new Vector3f(0, 0, 0), 1);
